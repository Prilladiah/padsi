...
export default function LaporanPendapatanPage() {
  ...
  const dataPendapatan: LaporanPendapatan[] = [
    {
      tanggal: '01-01-2025',
      unit_bisnis: 'Cafe',
  ...
  const totalPendapatan = dataPendapatan.reduce((total, item) => {
    return total + parseInt(item.sub_total.replace(/[^\d]/g, ''));
  }, 0);

  const handleDownload = (format: string) => {
    alert(`Mendownload laporan pendapatan dalam format ${format.toUpperCase()}`);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="w-6 h-6 text-blue-600">DOC</div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-4 border border-gray-300 rounded-lg hover:bg-gray-50"
            >
              <div className="w-6 h-6 text-green-600">XLS</div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-4 border border-gray-300 rounded-lg hover:bg-gray-50"
            >
              <div className="w-6 h-6 text-red-600">PDF</div>
